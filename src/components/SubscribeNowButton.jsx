...
const SubscribeNowButton = () => {
  ...
  return (
    <div className="mx-auto h-3/4 w-full max-w-60 bg-black">
      <motion.button
        ref={ref}
        style={{
          transform,
        ...
        className="group flex h-3/4 w-full items-center justify-between shadow-lg shadow-black bg-[#b2d12e] px-8 text-xl font-semibold border-black border-2"
      >
        <Copy>SUBSCRIBE NOW</Copy>
        <Arrow />
      </motion.button>
    </div>
  );
