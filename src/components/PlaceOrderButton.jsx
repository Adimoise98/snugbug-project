...
const PlaceOrderButton = () => {
  ...
  return (
    <div className="mx-auto h-[60px] w-full bg-black">
      <motion.button
        ref={ref}
        style={{
          transform,
        ...
        className="group flex text-center h-[60px] w-full items-center justify-around shadow-lg shadow-black bg-[#b2d12e] px-8 text-xl font-semibold border-black border-2"
      >
        <Copy>PLACE ORDER</Copy>
        <Arrow />
      </motion.button>
    </div>
  );
